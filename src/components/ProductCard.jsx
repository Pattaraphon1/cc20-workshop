...
function ProductCard(props) {
  ...
  console.log(image)
  return (
    <div className="card bg-base-100 w-80 shadow-sm pt-5 mx-auto">
      ...
      <div className="card-body">
        ...
        <p className="border w-30 p-2 mx-auto text-center font-bold rounded-full bg-pink-100 text-pink-500">{category}</p>
